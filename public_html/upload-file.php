...
<head>
	...
	<style type="text/css">
		...
		#bod{background-image:url('software-images/pexels-lukas-590016.jpg');background-size:100% 190%; background-repeat: no-repeat}
		...
		input[type="file"]::file-selector-button{border: 1px solid #ccc;border-radius: 4px;padding: 10px;}
